      ...
      <Card class="register-card">
        <template #header>
          <div class="card-header">
            <i class="pi pi-user-plus text-4xl text-primary mb-2"></i>
            <h1 class="text-2xl font-bold mb-1">Create Account</h1>
            <p class="text-surface-600">Join TaskFlow today</p>
          </div>
        </template>
        ...
        <template #content>
          <form @submit.prevent="handleSubmit" class="register-form">
            ...
            <div class="field">
              ...
              />
              <small v-if="errors.confirmPassword" id="confirmPassword-error" class="p-error">
